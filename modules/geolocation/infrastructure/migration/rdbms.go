...
import (
	migRunner "github.com/d3ta-go/ddd-mod-geolocation/modules/geolocation/infrastructure/migration/rdbms"
...
func NewRDBMSMigration(h *handler.Handler) (*RDBMSMigration, error) {
	...
	if mig.migrator, err = migRDBMS.NewBaseGormMigrator(h, cfg.Databases.MainDB.ConnectionName); err != nil {
		return nil, err
	}
...
func (m *RDBMSMigration) _runMigrates() error {
	...
	if err := m.migrator.RunMigrates(m.handler, cfg.Databases.MainDB.ConnectionName,
...
func (m *RDBMSMigration) _rollBackMigrates() error {
	...
	if err := m.migrator.RollBackMigrates(m.handler, cfg.Databases.MainDB.ConnectionName,
		migrate20201119001InitTable,
	); err != nil {
		return err
	}
...
func (m *RDBMSMigration) _runSeeds() error {
	...
	if err := m.migrator.RunSeeds(m.handler, cfg.Databases.MainDB.ConnectionName,
...
func (m *RDBMSMigration) _rollBackSeeds() error {
	...
	if err := m.migrator.RollBackSeeds(m.handler, cfg.Databases.MainDB.ConnectionName,
		seed20201119001InitTable,
	); err != nil {
		return err
	}
